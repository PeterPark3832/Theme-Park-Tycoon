...
export const B = {
  ...
  rollerCoaster:{emoji:"🎢",baseCost:12000,cat:"ride",  size:{w:5,h:3},color:"#FF6B9D",upgradeCost:[10000,25000],flavor:{ko:"최강 놀이기구 — 별점 상승에 최고",en:"Peak attraction — best for star rating"},levelEmoji:["🎢","🎢","🚀"],stats:lv=>({attraction:32+lv*13,rpv:0,      maintenance:550+lv*160,satBonus:0, cap:70+lv*30})},
  ...
  bumperCars:  {emoji:"🚗",baseCost:3200, cat:"ride",   size:{w:2,h:2},color:"#FF4757",upgradeCost:[2000,5000],  flavor:{ko:"저비용 초반 필수 — 만족도+놀이기구",en:"Budget early pick — satisfaction + attraction"},stats:lv=>({attraction:10+lv*5, rpv:0,      maintenance:100+lv*40, satBonus:2+lv,cap:40+lv*20})},
