...
export const TUTORIAL_STEPS = [
  {title:"🎪 입구 게이트 배치",text:"건설 탭에서 🎪 입구 게이트를 그리드에 배치하세요. 입구가 없으면 방문객이 들어올 수 없어요!"},
  {title:"🛤️ 통로 연결",text:"입구 옆에 통로를 연결하세요. 드래그로 여러 개를 한번에 놓을 수 있어요. 통로가 없으면 방문객이 시설을 이용할 수 없어요!"},
  {title:"🎡 놀이기구 건설",text:"관람차·회전목마 등 놀이기구를 통로 옆에 배치하세요. 다양한 종류를 지을수록 더 많은 방문객이 찾아와요!"},
  {title:"▶ 공원 개장",text:"상단 ▶ 버튼으로 시간을 시작하세요. ⏩ 빨리감기로 첫 방문객이 들어오는 순간을 빠르게 확인할 수 있어요!"},
...
// Synergy combo definitions — buildings[] must all be within `radius` Manhattan distance of each other
export const COMBOS = [
  // ── Romance ──
  {id:"night_romance",   emoji:"🌙", tier:1, color:"#FF6B9D",
   buildings:["ferrisWheel","fountain"],   radius:5,
   name:{ko:"야경 로맨스",   en:"Night Romance"},
   desc:{ko:"커플 방문객 +25% · 명성 +2",          en:"Couple visitors +25% · Prestige +2"},
   bonus:{coupleMult:0.25, prestige:2}},
  {id:"perfect_shot",    emoji:"📸", tier:1, color:"#A29BFE",
   buildings:["ferrisWheel","photoBooth"], radius:5,
   name:{ko:"완벽한 순간",   en:"Perfect Shot"},
   desc:{ko:"커플 방문객 +20% · 수익 +15%",        en:"Couple visitors +20% · Revenue +15%"},
   bonus:{coupleMult:0.20, revMult:0.15}},
  {id:"garden_promise",  emoji:"🌸", tier:1, color:"#FF9F43",
   buildings:["fountain","garden"],        radius:5,
   name:{ko:"정원의 약속",   en:"Garden Promise"},
   desc:{ko:"커플 만족도 +20%",                    en:"Couple satisfaction +20%"},
   bonus:{coupleMult:0.20}},
  {id:"couples_heaven",  emoji:"💕", tier:3, color:"#FF6B9D",
   buildings:["ferrisWheel","fountain","photoBooth"], radius:6,
   name:{ko:"커플의 천국",   en:"Couple's Heaven"},
   desc:{ko:"커플 +35% · 전체 수익 +20%",          en:"Couples +35% · All revenue +20%"},
   bonus:{coupleMult:0.35, revMult:0.20}},
  // ── Thrill ──
  {id:"adrenaline_alley",emoji:"⚡", tier:1, color:"#FF4757",
   buildings:["rollerCoaster","thrillRide"],radius:5,
   name:{ko:"어드레날린 골목",en:"Adrenaline Alley"},
   desc:{ko:"스릴 방문객 +30% · 라이드 수익 +15%", en:"Thrill visitors +30% · Ride revenue +15%"},
   bonus:{thrillMult:0.30, revMult:0.15}},
  {id:"wet_and_wild",    emoji:"💦", tier:1, color:"#48DBFB",
   buildings:["rollerCoaster","waterRide"], radius:5,
   name:{ko:"여름의 절정",   en:"Wet & Wild"},
   desc:{ko:"만족도 +10 · 여름 시즌 보너스 ×1.2",  en:"Satisfaction +10 · Summer ×1.2"},
   bonus:{satBonus:10, summerMult:0.20}},
  // ── Family ──
  {id:"little_paradise", emoji:"👶", tier:1, color:"#FECA57",
   buildings:["carousel","kidsPlayground"],radius:5,
   name:{ko:"꼬마의 낙원",   en:"Little Paradise"},
   desc:{ko:"어린이 +30% · 가족 만족도 +15%",      en:"Child visitors +30% · Family satisfaction +15%"},
   bonus:{childMult:0.30, familySat:15}},
  {id:"family_kingdom",  emoji:"🎠", tier:3, color:"#FF9F43",
   buildings:["carousel","kidsPlayground","miniTrain"], radius:6,
   name:{ko:"가족 왕국",     en:"Family Kingdom"},
   desc:{ko:"가족 +40% · 어린이 +15%",             en:"Family +40% · Children +15%"},
   bonus:{familyMult:0.40, childMult:0.15}},
  // ── Commerce ──
  {id:"snack_street",    emoji:"🍡", tier:1, color:"#FECA57",
   buildings:["foodStall","iceCream"],     radius:5,
   name:{ko:"스낵 골목",     en:"Snack Street"},
   desc:{ko:"음식 수익 +25% · 가족 방문객 +10%",   en:"Food revenue +25% · Family visitors +10%"},
   bonus:{revMult:0.25, familyMult:0.10}},
  // ── Entertainment ──
  {id:"culture_plaza",   emoji:"🎭", tier:1, color:"#9B7FFF",
   buildings:["amphitheater","coffeeCafe"],radius:5,
   name:{ko:"문화 광장",     en:"Culture Plaza"},
   desc:{ko:"일반 방문객 +20% · 만족도 +8",        en:"General visitors +20% · Satisfaction +8"},
   bonus:{generalMult:0.20, satBonus:8}},
  // ── Luxury ──
  {id:"grand_plaza",     emoji:"⭐", tier:1, color:"#A29BFE",
   buildings:["vipLounge","fountain"],     radius:5,
   name:{ko:"귀빈 광장",     en:"Grand Plaza"},
   desc:{ko:"VIP 이벤트 빈도 +30% · 수익 +15%",   en:"VIP event rate +30% · Revenue +15%"},
   bonus:{vipMult:0.30, revMult:0.15}},
  // ── Operations ──
  {id:"full_service",    emoji:"🏥", tier:1, color:"#00E5A0",
   buildings:["firstAid","restroom"],      radius:5,
   name:{ko:"완벽한 서비스", en:"Full Service"},
   desc:{ko:"재난 피해 -20% · 만족도 +5",          en:"Disaster damage -20% · Satisfaction +5"},
   bonus:{disasterMitigation:0.20, satBonus:5}},
];
